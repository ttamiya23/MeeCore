...
void fake_digital_init(void *ctx)
{
...
mc_status_t fake_digital_set_state(void *ctx, bool state)
{
    fake_digital_ctx_t *digital_ctx = (fake_digital_ctx_t *)ctx;
...
mc_result_t fake_digital_get_state(void *ctx)
{
    fake_digital_ctx_t *digital_ctx = (fake_digital_ctx_t *)ctx;
...
const mc_digital_driver_t fake_digital_driver = {
    .init = fake_digital_init,
    .set_state = fake_digital_set_state,
    .get_state = fake_digital_get_state};
